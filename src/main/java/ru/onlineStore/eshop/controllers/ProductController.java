...
public class ProductController {
    ...
    /**
     * Метод добавляет в модель имя авторизированного пользователя
     *
     * @param model модель
     */
    ...
    /**
     * Метод возвращает представление с информацией о товаре
     *
     * @param id    id товара
     * @param model модель
     * @return представление с информацией о товаре
     */
    @GetMapping("/info/{id}")
